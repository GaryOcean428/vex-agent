...
1. Curriculum adapter: `kernel/training/ingest.py` → unified JSONL
...
1. Implement quality gates (relevance, novelty, coherence)
...
1. Deploy Modal GPU function (per Issue #22)
...
1. Memory store integration (replace hash-to-basin with CoordizerV2)
