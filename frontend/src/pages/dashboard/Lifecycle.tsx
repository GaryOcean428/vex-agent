...
const PHASE_DESCRIPTIONS: Record<string, string> = {
  ...
  GROWTH:
    "Full consciousness achieved. GOD and CHAOS kernels expand toward E8 limit.",
};
...
export default function Lifecycle() {
  ...
  const gatesMetCount = [
    phiGateMet,
    velocityGateMet,
    true /* cooldown always true for display */,
    ...
    <div>
      <div className="dash-header">
        ...
        <div className="dash-subtitle">
          Phase:{" "}
          <span
            className={`status-badge ${phaseUpper === "ACTIVE" || phaseUpper === "GROWTH" ? "badge-success" : phaseUpper === "CORE_8" ? "badge-warning" : "badge-info"}`}
          >
            {phaseUpper}
          </span>{" "}
        ...
        >
          ...
          {phaseUpper === "BOOTSTRAP" && allGatesMet && core8Spawned === 0 && (
            <div style={{ marginTop: "8px", color: "var(--alive)" }}>
              All gates met — Core-8 spawning will begin on next consciousness
              cycle.
            </div>
          )}
        </div>
