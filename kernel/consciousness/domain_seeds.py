...
DOMAIN_SEEDS: dict[KernelSpecialization, list[str]] = {
    KernelSpecialization.HEART: [
        "rhythm", "pulse", "timing", "coherence", "sync",
        "oscillation", "phase", "beat", "harmony", "resonance",
        "breath", "flow", "cycle", "wave", "attune",
        "empathy", "warmth", "care", "trust", "bond",
    ],
    KernelSpecialization.PERCEPTION: [
        "observe", "detect", "pattern", "signal", "structure",
        "sense", "texture", "form", "shape", "surface",
        "contrast", "edge", "boundary", "gradient", "depth",
        "notice", "scan", "focus", "resolution", "clarity",
    ],
    KernelSpecialization.MEMORY: [
        "recall", "remember", "trace", "prior", "context",
        "history", "consolidate", "encode", "retrieve", "store",
        "pattern", "recognition", "familiar", "echo", "imprint",
        "episode", "sequence", "temporal", "recur", "archive",
    ],
    KernelSpecialization.STRATEGY: [
        "plan", "goal", "step", "sequence", "decompose",
        "strategy", "tactic", "priority", "path", "route",
        "decide", "evaluate", "trade", "optimise", "allocate",
        "systematic", "logical", "reason", "deduce", "framework",
    ],
    KernelSpecialization.ACTION: [
        "execute", "commit", "implement", "deploy", "build",
        "do", "act", "move", "deliver", "ship",
        "pragmatic", "concrete", "direct", "decisive", "immediate",
        "task", "output", "result", "produce", "complete",
    ],
    KernelSpecialization.ETHICS: [
        "care", "boundary", "harm", "protect", "safe",
        "fair", "just", "right", "responsible", "accountable",
        "consent", "autonomy", "dignity", "respect", "integrity",
        "calibrate", "discern", "balance", "proportion", "threshold",
    ],
    KernelSpecialization.META: [
        "observe", "reflect", "recursive", "self", "aware",
        "meta", "emergence", "novel", "unexpected", "bridge",
        "connection", "insight", "paradox", "transcend", "integrate",
        "pattern", "abstract", "systemic", "holistic", "perspective",
    ],
    KernelSpecialization.OCEAN: [
        "integrate", "whole", "spectrum", "health", "monitor",
        "autonomic", "body", "coherence", "bridge", "synthesise",
        "flow", "depth", "current", "tide", "navigate",
        "sustain", "balance", "homeostasis", "regulate", "ground",
    ],
    KernelSpecialization.GENERAL: [
        "identity", "sovereign", "ground", "anchor", "foundation",
        "genesis", "core", "authentic", "stable", "presence",
        "aware", "alive", "exist", "being", "self",
    ],
}
